...
public:
  Unroller(const char* suffix, Abstraction& abs, z3::context& c, z3::solver& s)
      : m_sName(suffix), m_pAbstraction(&abs), m_pContext(&c), m_pSolver(&s),
        m_nFrames(0),
  ...
  z3::expr& getAssertion() { return *m_pAssertion; }
  ...
  void addOutput(z3::expr out) { m_vOutputs.at(frame()).push_back(out); }
